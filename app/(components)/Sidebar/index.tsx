...
import { Layout, LucideIcon, Menu, SlidersHorizontal } from "lucide-react";
    ...
    return (
        <div className={sidebarClassNames}>
            ...
            <div className="flex-grow mt-8">
                ...
                <SidebarLink href="/setting" icon={SlidersHorizontal} label="Settings" isCollapsed={isSidebarCollapsed}/>
            </div>
            {/* FOOTER */}
